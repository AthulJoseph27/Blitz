...
void NeuralNetwork::readConfiguration()
{
	std::fstream file;
...
NeuralNetwork::NeuralNetwork(std::vector<int> layerCount, std::vector<std::string> activation)
{
...
void NeuralNetwork::Normalize(std::vector<std::vector<std::vector<double>>> &data_labels, std::string function)
{
...
void NeuralNetwork::trainBatch(std::vector<std::vector<double>> &labels, std::vector<std::vector<double>> &data, int start, int end)
{
...
void NeuralNetwork::shuffleData(std::vector<std::vector<std::vector<double>>> &data)
{
...
void NeuralNetwork::train(std::vector<std::vector<std::vector<double>>> &data_labels, std::string normalizingFunction)
{
...
Matrix NeuralNetwork::predict(std::vector<double> data)
{
...
void NeuralNetwork::readModel(std::string fileName)
{
